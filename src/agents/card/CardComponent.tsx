...
const CARD_ART: Record<number, string> = {
  ...
  18: `${BASE}cards/cauliflower-mushroom.png`,
  19: `${BASE}cards/wood-ear.png`,
  20: `${BASE}cards/coral-mushroom.jpg`,
  21: `${BASE}cards/fly-agaric.png`,
  22: `${BASE}cards/destroying-angel.png`,
  23: `${BASE}cards/death-cap.png`,
  24: `${BASE}cards/jack-o-lantern.png`,
  25: `${BASE}cards/false-morel.png`,
  26: `${BASE}cards/panther-cap.png`,
  27: `${BASE}cards/stinkhorn.png`,
  28: `${BASE}cards/deadly-galerina.png`,
  29: `${BASE}cards/witchs-butter.png`,
  30: `${BASE}cards/pigskin-puffball.png`,
  ...
  36: `${BASE}cards/black-trumpet.png`,
