...
export const CARDS: CardDefinition[] = [
  ...
  },
  {
    ...
    type: 'mycorrhizal',
    isOngoing: false,
    power: '[When Planted] +2 bonus points if this is the only Matsutake you own.',
  },
  {
    id: 15,
    ...
    type: 'mycorrhizal',
    isOngoing: false,
    power: '[When Planted] +1 point per other Chanterelle variant you own (max +2).',
  },
  {
    id: 17,
    name: 'Hedgehog',
  ...
  },
  {
    ...
    type: 'mycorrhizal',
    isOngoing: false,
    power: '[When Planted] Reduce an adjacent owned tile\'s spread cost to 1 permanently.',
  },
  {
    id: 41,
    name: 'Amanita Caesar',
